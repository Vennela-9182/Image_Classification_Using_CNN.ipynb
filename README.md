...
###Performance
Models reach 30-87% validation accuracy after 50+ epochs. Loss curves indicate reduced overfitting with augmentation (e.g., Model 8 outperforms baseline). Plots visualize training/validation loss and accuracy trends.
